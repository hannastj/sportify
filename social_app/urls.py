...
from .views import buddy_details_ajax, buddyup_view, buddy_profile_view, buddy_search_view, send_buddy_request_view, send_buddy_request_ajax, respond_buddy_request_view
